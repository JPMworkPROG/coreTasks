...
import { authConfig } from './config/envLoader';
...
async function bootstrap() {
  ...
  try {
    logger.info('Starting auth service (RabbitMQ microservice)');
    ...
    logger.info('Auth microservice is listening for RabbitMQ messages', {
      queue: config.rabbitmq.queue,
